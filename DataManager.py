...
# PROMISE12 dataset isotropically scaled to 1x1x1.5mm, volume resized to 128x128x64
...
class DataManager(object):
    ...
    def createImageFileList(self):
        self.fileList = [f for f in listdir(self.srcFolder) if isfile(join(self.srcFolder, f)) and '.DS_Store' not in f and 'segmentation' not in f and 'raw' not in f]
